...
import { getTapPath, setTapPath, loadConfig, getConfigPath } from '../lib/config.js';
...
configCmd
  ...
  .action(async () => {
    ...
    if (tapPath) {
      ...
      console.log(chalk.yellow('No tap path configured. Run: allbrew config set-tap <path>'));
    }
  });
