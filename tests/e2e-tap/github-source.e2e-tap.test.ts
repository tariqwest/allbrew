...
describe.skipIf(!E2E_TAP)("github-source: source-build", () => {
  let ctx: TestContext;
  const app = getFixtureApp("fake-src");
...
describe.skipIf(!E2E_TAP)("github-source: spm-package", () => {
  let ctx: TestContext;
  const app = getFixtureApp("fake-spm");
...
describe.skipIf(!E2E_TAP)("github-source: mint-package", () => {
  let ctx: TestContext;
  const app = getFixtureApp("fake-mint");
