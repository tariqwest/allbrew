...
describe.skipIf(!E2E_TAP)("install-script", () => {
  let ctx: TestContext;
  const app = getFixtureApp("fake-install");
  ...
  describe("update", () => {
    it("should detect new version via livecheck, regenerate, push, and upgrade", () => {
      ...
      mutateApp(ctx, "fake-install", "2.0.0");
...
describe.skipIf(!E2E_TAP)("archive-build", () => {
  let ctx: TestContext;
  const app = getFixtureApp("fake-archive");
  ...
  describe("update", () => {
    it("should detect new version via livecheck, regenerate, push, and upgrade", () => {
      ...
      mutateApp(ctx, "fake-archive", "2.0.0");
...
describe.skipIf(!E2E_TAP)("binary-direct", () => {
  let ctx: TestContext;
  const app = getFixtureApp("fake-binary-direct");
  ...
  describe("update", () => {
    it("should detect new version via livecheck, regenerate, push, and upgrade", () => {
      ...
      mutateApp(ctx, "fake-binary-direct", "2.0.0");
