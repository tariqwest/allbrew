...
/**
 * Homebrew API bottle.files[*].cellar is already a Ruby-style symbol string
 * (e.g. ":any", ":any_skip_relocation"). Older callers may pass a bare name.
 * Never emit "::any" (double colon) — that is invalid Ruby.
 */
