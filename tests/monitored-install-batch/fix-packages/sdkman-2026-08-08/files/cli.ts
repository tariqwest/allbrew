...
async function handleBashScript(url, opts) {
  // Vendor install scripts often write $HOME dirs or open App Store / distro PMs
  // (e.g. https://sh.rustup.rs, https://get.sdkman.io). Prefer Case C official
  // Homebrew packages over minting Empty-installation PREFIX formulas.
  let body = "";
  try {
