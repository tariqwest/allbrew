FORMULA_PATH=/Users/th-allbrew/homebrew-allbrew/Formula/devonthink.rb
class Devonthink < Formula
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/devonthink --version")
  end
end