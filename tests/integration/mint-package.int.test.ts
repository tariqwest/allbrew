...
describe.concurrent("mint-package integration", () => {
  it("iblinter: payload fields are well-formed (with release)", async () => {
    const payload = await collectMintPackagePayload(iblinterRepoInfo, iblinterRelease);
  ...
  it("iblinter: head-only mode (no release)", async () => {
    const payload = await collectMintPackagePayload(iblinterRepoInfo, null);
    const ruby = renderFormula(payload);
    assertValidFormula(ruby);
  ...
  it("mockolo: generates valid formula (head-only)", async () => {
    const payload = await collectMintPackagePayload(mockoloRepoInfo, null);
    const ruby = renderFormula(payload);
    assertValidFormula(ruby);
  ...
  it("swift-outdated: generates valid formula (head-only)", async () => {
    const payload = await collectMintPackagePayload(swiftOutdatedRepoInfo, null);
    const ruby = renderFormula(payload);
    assertValidFormula(ruby);
  ...
  it("licenseplist: generates valid formula (head-only)", async () => {
    const payload = await collectMintPackagePayload(licensePlistRepoInfo, null);
    const ruby = renderFormula(payload);
    assertValidFormula(ruby);
  ...
  it("bartycrouch: generates valid formula (head-only)", async () => {
    const payload = await collectMintPackagePayload(bartyCrouchRepoInfo, null);
    const ruby = renderFormula(payload);
    assertValidFormula(ruby);
  ...
  it("swiftplantuml: generates valid formula (head-only)", async () => {
    const payload = await collectMintPackagePayload(swiftPlantUmlRepoInfo, null);
    const ruby = renderFormula(payload);
    assertValidFormula(ruby);
  ...
  it("asccli: generates valid formula (head-only)", async () => {
    const payload = await collectMintPackagePayload(ascCliRepoInfo, null);
    const ruby = renderFormula(payload);
    assertValidFormula(ruby);
