...
import type { RubyGemPayload } from "../template-payload.ts";
import { writeRenderedFormula } from "../template-renderer.ts";

export async function collectRubyGemPayload(
  gemName: string,
  repoInfo: any = null,
  options: any = {},
): Promise<RubyGemPayload> {
...
export async function generateRubyGem(
  gemName: string,
  repoInfo: any = null,
  options: any = {},
) {
  const payload = await collectRubyGemPayload(gemName, repoInfo, options);
