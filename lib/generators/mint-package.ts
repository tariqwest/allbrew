...
import type { MintPackagePayload } from "../template-payload.ts";
import { writeRenderedFormula } from "../template-renderer.ts";

export async function collectMintPackagePayload(
  repoInfo: any,
  release: any,
  options: any = {},
): Promise<MintPackagePayload> {
...
export async function generateMintPackage(
  repoInfo: any,
  release: any,
  options: any = {},
) {
  const payload = await collectMintPackagePayload(repoInfo, release, options);
