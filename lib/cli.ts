...
async function handleNpmPackage(classification, opts) {
  ...
  // Registry packages (verdaccio, etc.) often document a long-running server.
  // npm registry `readme` may be empty while the GitHub README has full docs —
  // resolveNpmPackageServiceConfig falls back to the repository README.
